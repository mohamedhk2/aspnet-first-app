...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E2789F6467F");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B44FB369DE");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB857E464C88");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229C4277B94");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4539F3FD3");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF554AA8D86");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CD24B9A23");

            entity.ToTable("staffs");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61649C25D1FA").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D32A440052");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C1DC61FF2");
